"""Plugin lifecycle hooks for the Bluesky Integration plugin.
...
def install(**kwargs):
    ...
    # 3. Create symlink so 'from plugins.bluesky.helpers...' imports work
...
def uninstall(**kwargs):
    ...
    # Remove skills
    skills_dst = a0_root / "usr" / "skills"
    for skill_name in ['bluesky-engage', 'bluesky-post', 'bluesky-research', 'bluesky-thread']:
